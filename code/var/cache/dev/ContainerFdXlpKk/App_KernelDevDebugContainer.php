...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('form.post_submit', [0 => function () {
            return ($this->privates['App\\EventListener\\ArticleFormListener'] ?? ($this->privates['App\\EventListener\\ArticleFormListener'] = new \App\EventListener\ArticleFormListener()));
        }, 1 => 'onPostSubmit'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+kWE7y6ppD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
